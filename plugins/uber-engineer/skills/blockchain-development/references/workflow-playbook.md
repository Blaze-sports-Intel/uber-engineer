...
- **Write deterministic test suites against forked mainnet state** → Foundry/Hardhat test suite with coverage report.
...
- **Apply reentrancy, integer overflow, and signature-replay guards by default** → Mainnet deploy checklist with multisig sign-off.
